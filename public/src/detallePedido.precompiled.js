...
templates['detallePedido'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<h1 id=\"stock\"><strong> Detalle en pedidos </strong></h1>\n<div class=\"divEnlaces\">\n<a class=\"enlaces\" href=\"/pedidosEnProceso\"><button class=\"btn btn-primary mr-3 float-left\">Pedidos En Proceso</button></a>\n<a class=\"enlaces\" id=\"imprimir/"
    + alias4(((helper = (helper = lookupProperty(helpers,"id_pedido") || (depth0 != null ? lookupProperty(depth0,"id_pedido") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id_pedido","hash":{},"data":data,"loc":{"start":{"line":5,"column":32},"end":{"line":5,"column":45}}}) : helper)))
